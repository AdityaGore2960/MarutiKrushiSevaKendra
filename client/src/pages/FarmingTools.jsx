...
const FarmingToolsLocalizedContent = ({ page }) => (
...
const FarmingTools = () => {
  ...
  useEffect(() => {
    setLoading(true);
    setError('');
    getProducts({ categorySlug: 'farming-tools' })
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-white rounded-2xl border border-gray-100 p-6">
            <p className="text-gray-500 text-sm font-medium">{t('farmingToolsPage.noProducts')}</p>
          </div>
        )}

        {/* SEO / Extra Content Section */}
        {language === 'mr' ? <FarmingToolsLocalizedContent page={page} /> : <div className="mt-16 bg-white rounded-2xl p-6 md:p-8 border border-gray-100 shadow-sm text-gray-600 space-y-6">
          <section>
